...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        `inline-flex items-center w-full bg-[#27272c] whitespace-nowrap justify-center text-white
        rounded-lg p-3 text-base font-medium
        ring-offset-white transition-all disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-accent data-[state=active]:text-primary data-[state=active]:shadow-sm
        data-[state=active]:fontbold`,
        className
      )}
      {...props} />
  );
